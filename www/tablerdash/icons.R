...
icon_graph <- function(size = 24, class = "") {
  class <- paste("icon icon-tabler icon-tabler-calculator", class)
  tags$svg(
    xmlns = "http://www.w3.org/2000/svg",
    class = class,
    ...
    HTML('<path d="M4 18v-12a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" />
  <path d="M7 14l3 -3l2 2l3 -3l2 2" />')
  )
}

icon_hosp <- function(size = 24, class = "") {
  class <- paste("icon icon-tabler icons-tabler-outline icon-tabler-building-hospital", class)
  tags$svg(
    xmlns = "http://www.w3.org/2000/svg",
    class = class,
    width = "24",
    ...
    HTML('<path d="M3 21l18 0" /><path d="M5 21v-16a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v16" />
    <path d="M9 21v-4a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v4" /><path d="M10 9l4 0" /><path d="M12 7l0 4" />')
  )
}
