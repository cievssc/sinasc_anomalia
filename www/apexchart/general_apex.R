 ...
 apex <- function(){
  htmltools::htmlDependency(
    name = "apexcharts",
    version = "4.0",
    src = c(href = "https://cdnjs.cloudflare.com/ajax/libs/apexcharts/4.0.0"),
    script = "apexcharts.min.js",
    stylesheet = 'apexcharts.min.css'
  )}
 ...
 apexchartOutput <- function(inputId, width="100%", height="100%") { #
  ...
  tagList(
    ...
    singleton(tags$head(
      ...
      #tags$script(src = 'https://cdn.jsdelivr.net/npm/apexcharts'),#src="https://cdnjs.cloudflare.com/ajax/libs/apexcharts/3.54.1/apexcharts.min.js"),
